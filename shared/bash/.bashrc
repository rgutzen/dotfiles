...
# terminal colours — Thrifted Rug (base24) via OSC escape sequences
BASE24_THEME=~/.cache/tinted-templates/tinted-shell/scripts/base24-thrifted-rug.sh
[ -f "$BASE24_THEME" ] && . "$BASE24_THEME"
