# PAZRAS — the P.A.Z.R.A.S folder system and its helper scripts.
...
[ -f "$HOME/06_SYSTEM/scripts/shell/pazras-aliases.sh" ] && . "$HOME/06_SYSTEM/scripts/shell/pazras-aliases.sh"
